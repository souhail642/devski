...
public class RegistrationServicesImpl implements  IRegistrationServices{
    ...
    private Registration handleCollectiveChildrenCourse(Registration registration, Skier skier, Course course, int ageSkieur) {
        if (ageSkieur < 16) {
            log.info("Ok CHILD !");
            return handleCollectiveCourse(registration, skier, course);
        } else {
    ...
    private Registration handleCollectiveCourse(Registration registration, Skier skier, Course course) {
